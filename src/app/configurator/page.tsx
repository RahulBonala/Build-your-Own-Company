          ...
          <div className="absolute bottom-8 text-center flex flex-col items-center gap-3 z-20 w-full px-4">
            ...
            {isReady && (
              <motion.button
                ...
                className={`w-full lg:w-auto px-8 py-3 font-bold text-lg uppercase tracking-widest rounded-sm transition-all cursor-pointer ${
                  isNavigating
                    ? 'bg-gray-600 text-gray-400 cursor-not-allowed'
                    : 'bg-cyber-cyan text-obsidian shadow-[0_0_20px_rgba(255,107,26,0.4)] hover:bg-white'
                }`}
              >
