                ...
                >
                    <div className="flex items-center justify-between mb-8 gap-4 flex-wrap">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-2xl md:text-4xl font-black text-white tracking-tighter">BLUEPRINT SUMMARY</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <div className="bg-white/5 border border-glass-border rounded-lg p-6">
                                ...
                                <div className="space-y-4">
                                    {(Object.entries(selections) as [keyof PricingDataType, string | null][]).map(([key, value]) => {
                                            ...
                                            >
                                                ...
                                                <div className="text-right">
                                                    <div className="text-white font-mono font-bold">
                                                        {item.price ? `₹${item.price.toLocaleString()}` : `₹${(item.setup || 0).toLocaleString()}`}
                                                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-gradient-to-br from-gray-900 to-black border border-cyber-cyan/30 rounded-lg p-8 shadow-2xl relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight">₹{quote.oneTimeCost.toLocaleString()}</div>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-5 bg-cyber-cyan text-obsidian font-black text-xl uppercase tracking-widest rounded hover:bg-white transition-colors shadow-[0_0_30px_rgba(102,252,241,0.3)] hover:scale-[1.02] transform duration-200 cursor-pointer"
                                    >
                                        Pay 50% Deposit
                                    </button>
                        ...
                        >
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-3 bg-cyber-cyan hover:bg-cyan-300 text-black rounded font-bold transition-colors flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                                >
                                    {isProcessing ? (
                                        <>
                                            <motion.div
