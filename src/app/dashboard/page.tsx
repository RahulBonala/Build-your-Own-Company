...
const LiveTelemetry = dynamic(() => import('@/components/dashboard/LiveTelemetry'), {
  ssr: false,
  loading: () => <div className="h-[350px] bg-slate-800/50 rounded-2xl animate-pulse" />,
});
...
export default function DashboardPage() {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-obsidian text-white p-4 md:p-8 font-sans selection:bg-cyber-cyan/30 overflow-x-hidden relative">
        {/* Background Ambience */}
        <div className="fixed inset-0 pointer-events-none">
          <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-cyber-cyan/10 rounded-full blur-[100px]" />
