  ...
  return (
    <PageTransition>
      <div
        ...
        onKeyDown={(e) => {
          if (e.key === 'Enter' || e.key === ' ') handleFastForward();
        }}
        role="button"
        tabIndex={0}
            ...
            {step === 1 && (
              ...
              >
                ...
                <div className="text-lg text-gray-400">
                  Let&apos;s assemble your vision:{' '}
                  <span className="text-cyber-cyan underline">{idea || 'The Next Big Thing'}</span>.
                </div>
              </motion.div>
            )}
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-8 py-3 bg-cyber-cyan hover:bg-white text-obsidian font-bold rounded-lg transition-all shadow-[0_0_20px_rgba(255,107,26,0.35)] hover:scale-105 cursor-pointer"
                  >
