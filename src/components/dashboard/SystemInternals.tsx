...
export default function SystemInternals() {
  ...
  const mktLabel = selections.marketing
    ? PRICING_DATA.marketing[selections.marketing]?.label
    : null;
        ...
        <div className="bg-slate-900/50 p-4 rounded-xl border border-white/5 hover:border-orange-500/50 transition-colors group">
          ...
          <div className="space-y-1">
            ...
            <div
              ...
              title="feat: auth_middleware implementation"
            >
            ...
            {dbInfo ? (
              <>
                ...
                <div className="w-full bg-slate-800 h-1 rounded-full mt-2 overflow-hidden">
                  <div
                    className={`h-full ${dbInfo.color} transition-all duration-1000`}
                    style={{ width: dbInfo.fill }}
                  />
                </div>
              </>
            ) : (
