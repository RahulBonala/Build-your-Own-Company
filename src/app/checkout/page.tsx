...
import { PRICING_DATA, PricingDataType } from '@/utils/PricingData';
import { motion } from 'framer-motion';
import { CheckCircle, Clock, Database, Zap, Headphones, ArrowLeft } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  // Route guard: redirect if no selections
  useEffect(() => {
    if (hydrated) {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-obsidian text-silver p-4 md:p-8 flex flex-col items-center relative">
        <motion.div
          ...
          <div className="flex items-center justify-between mb-8 gap-4 flex-wrap">
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-sm text-gray-400 hover:text-white bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-all cursor-pointer"
              >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-purple-900/30 border border-purple-500/50 text-purple-300 rounded hover:bg-purple-900/50 transition-colors cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="bg-white/5 border border-glass-border rounded-lg p-6">
                ...
                <div className="space-y-4">
                  {(Object.entries(selections) as [keyof PricingDataType, string | null][]).map(
                    ([key, value]) => {
                      ...
                      return (
                        ...
                        >
                          <div>
                            <div className="text-xs text-cyber-cyan uppercase font-mono tracking-widest mb-1">
                              {key}
                            </div>
              ...
              <div className="bg-white/5 border border-glass-border rounded-lg p-6 flex justify-between items-center">
                ...
                <div>
                  ...
                  <div className="text-2xl font-black text-white">
                    ₹{quote.monthlyCost.toLocaleString()}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-gray-900 to-black border border-cyber-cyan/30 rounded-lg p-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="text-sm text-cyber-cyan font-mono uppercase tracking-widest mb-2">
                    Total Build Cost
                  </div>
                  <div className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight">
                    ₹{quote.oneTimeCost.toLocaleString()}
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex justify-between text-sm items-center">
                      ...
                      <span className="font-bold text-white text-xl">
                        ₹{(quote.oneTimeCost * 0.5).toLocaleString()}
                      </span>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full py-5 bg-cyber-cyan text-obsidian font-black text-xl uppercase tracking-widest rounded hover:bg-white transition-colors shadow-[0_0_30px_rgba(255,107,26,0.3)] hover:scale-[1.02] transform duration-200 cursor-pointer"
                  >
                    Pay 50% Deposit
                  </button>
        ...
        {showPaymentModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            ...
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-cyber-cyan to-[#c2410c]" />

              <h3 className="text-2xl font-bold text-white mb-2">Secure Payment</h3>
              <p className="text-slate-400 text-sm mb-6">
                Completing transaction via Secure Gateway...
              </p>

              <div className="bg-obsidian p-4 rounded-lg mb-6 border border-white/5">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 py-3 bg-slate-800 hover:bg-slate-700 text-white rounded font-bold transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-3 bg-cyber-cyan hover:bg-white text-black rounded font-bold transition-colors flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                >
                  {isProcessing ? (
                    <>
                      <motion.div
