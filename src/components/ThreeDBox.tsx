...
export const ThreeDBox = () => {
  ...
  return (
    <div className="relative w-full h-[500px] flex items-center justify-center perspective-[1000px]">
      ...
      */}
      <motion.div
        className="relative w-64 h-[280px] bg-white/5 border border-white/20 rounded-lg flex flex-col-reverse justify-start p-2 shadow-[0_0_50px_rgba(255,107,26,0.1)] backdrop-blur-sm transform-style-3d rotate-x-6 gap-0.5"
        initial={{ opacity: 0 }}
